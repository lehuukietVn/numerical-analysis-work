...
Xét $\left\|B \right\|_{\infty} =\underset{1\leq i \leq 4}\max \sum\limits_{j=1}^{4}{\left\|b_{ij}\right\|}= 0,5<1
...
\end{tabular}\end{center}
Vậy hệ phương trình có nghiệm là $x*\approx x^{(5)} $ với sai số là 0,000139409.
\par
f)$A=\begin{pmatrix}	
2&-2&1&10\\	
10&-2&-1&1\\	
